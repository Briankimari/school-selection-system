...
export default function OpenForm() {
  ...
  const saveForm = async (e) => {
    ...
    try {
      await axios.post(
        "https://fastfood-api-bz41.onrender.com/save-student",
        {
          firstName,
          surName,
          indexNumber,
      ...
      toast.success(
        "saved successfully, select grade below to check school selected"
      );
    ...
    <div>
      <Box>
        <button
          ...
          className="p-2 text-white rounded-lg hover:drop-shadow-xl"
          ...
          <DialogContent dividers>
            ...
            <div className="flex items-center gap-3 mt-4">
              ...
              <p className="text-sm italic">
                I agree to all terms & conditions @2023
              </p>
            </div>
          </DialogContent>
          <DialogActions>
            <div
              style={{ background: currentColor }}
              className={`p-2 rounded-lg text-white uppercase text-center text-xl w-full ${
                isLoading
